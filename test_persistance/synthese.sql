DROP VIEW IF EXISTS gn_monitoring.v_synthese_test_persistance;
CREATE VIEW gn_monitoring.v_synthese_test_persistance AS WITH source AS (
	SELECT id_source
...
SELECT *
FROM gn_monitoring.v_synthese_test_persistance